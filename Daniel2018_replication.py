...
# param
N_AGENT = 100
N_TIME = 100 # N_AGENT * 10000 in the paper
N_TRAIL = 3 # 100 in the paper
...
def run_simulation(param_idx, decay_rate, log_data, rnd_seed):
    ...
    demo = Simulate(N=N_AGENT, decay_rate=decay_rate, times=N_TIME, log_measure_v=LOG_MEASURE_V, verbose=False)
...
if __name__ == "__main__":
    ...
    args_list = []
    for param_idx, dr in enumerate(np.arange(0.0, 1.0, 0.1)):
    ...
    plot_handler = PlotErrorBarHandler(xlabel="Decay Rate",
                                       ...
                                       title="N={}, Fully-Connect".format(N_AGENT),
                                       fn="errorbar_fully-connected",
